...
def main():
    ...
    l25_path = os.path.join(args.output_dir, "figure_4_cross_task_deepseek_l25_new.png")
    plot_single_layer_triplet(df, args.model, 25, task_order, l25_path)
    
    # 2. Plot Layer 30 Triplet
    l30_path = os.path.join(args.output_dir, "figure_4_cross_task_deepseek_l30_new.png")
    ...
    comp_path = os.path.join(args.output_dir, "figure_4_cross_task_comparison_new.png")
